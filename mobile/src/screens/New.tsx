...
const avaiableWeekDays = ['Domingo', 'Segunda-feira', 'Quarta-feira', 'Quinta-feira', 'Sexta-Feira', 'Sabado',]
    ...
    async function handleCreateNewHabit() {
        try {
            if (!title.trim() || weekDays.length === 0) {
                return Alert.alert('Novo hábito', 'Informe o nome do hábito e escolha a periodio do novo hábito')
            }
